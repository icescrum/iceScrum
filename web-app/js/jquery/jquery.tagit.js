...
(function ($) {
    $.widget("ui.tagit", {
        ...
        _create:function () {
            ...
            this.element.html('<li class="tagit-new"><span id="storyname-field" class="input"><span class="start"></span><span class="content"><input class="tagit-input" type="text" /></span><span class="end"></span></span></li>');
        ...
        _addTag:function (label, value) {
            ...
            tag.element.insertBefore(this.input.parents('li'));
