	...
	function QTip(target, options, id) {
		...
		$.extend(self, self.options.api, {
			...
			updatePosition: function (event, animate) {
				...
				if(event && posOptions.target === 'mouse') {
                ...
                if (position == null && posOptions.target === 'mouse'){
                   position = self.cache.mouse;
                }
                ...
                if(posOptions.container != $(document.body) ){
                    ...
                    if ($(posOptions.container).height() < position.top + elemHeight){
                        position.top = position.top - elemHeight;
                    }
                }
