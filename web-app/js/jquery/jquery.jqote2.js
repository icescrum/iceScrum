...
(function($) {
    ...
    $.each({app: 'append', pre: 'prepend', sub: 'html', up:'replaceWith'}, function(name, method) {
        $.fn['jqote' + name] = function(elem, data, t) {
            ...
            return this.each(function() {
                ...
                str = str.replace(/<js>/g, '<script type="text/javascript">');
                str = str.replace(/<\/js>/g, '</script>');
    ...
    $.event.special.jqote = {
        add: function(obj) {
            ...
            if (!obj.namespace) obj.namespace = 'app.pre.sub.up';
