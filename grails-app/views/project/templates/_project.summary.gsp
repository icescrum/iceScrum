...
<div class="row">
    <h4 class="col-md-6">
        ...
        <i class="fa fa-folder"></i> {{ project.name + ' (' + project.pkey + ')' }}
    </h4>
    <h4 class="col-md-6 text-right"><i class="fa fa-users"></i> {{ project.team.name }}</h4>
</div>
<div class="row project-desc-chart">
    <div class="col-md-5" ng-bind-html="project.description_html ? project.description_html : '<p>' + message('todo.is.ui.project.nodescription') + '</p>'"></div>
