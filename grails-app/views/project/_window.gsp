            ...
            <div class="card hover-container project-summary">
                ...
                <div class="card-body">
                    ...
                    <div class="avatars-and-stats">
                        <div class="avatars d-flex align-items-center justify-content-center" ng-class="{'avatars-size-sm': allMembers.length >= 12 && allMembers.length < 18, 'avatars-size-xs': allMembers.length >= 18}">
