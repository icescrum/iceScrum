...
<is:window windowDefinition="${windowDefinition}">
    <div class="card" ng-controller="elementsListMenuCtrl" ng-init="initialize(availableBacklogs, 'backlog', 'code')">
        <div class="card-header">
            <ul id="elementslist-list"
                class="nav nav-pills card-header-pills float-left"
        ...
        <div class="card-body" selectable="selectableOptions">
