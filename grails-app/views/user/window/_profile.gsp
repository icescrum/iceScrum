  ...
  <div class="colset-2-80 clearfix">
    ...
    <div class="col2">
      ...
      <is:panel id="panel-dates">
        ...
        <is:panelContext>
          <is:panelLine legend="${message(code:'is.user.dateCreated')}"><g:formatDate date="${user.dateCreated}" formatName="is.date.format.short" timeZone="${user?.preferences?.timezone?:null}"/></is:panelLine>
          <is:panelLine legend="${message(code:'is.user.lastUpdated')}"><g:formatDate date="${user.lastUpdated}" formatName="is.date.format.short" timeZone="${user?.preferences?.timezone?:null}"/></is:panelLine>
        </is:panelContext>
      </is:panel>
