...
<div class="box-blank clearfix">
    <p>${message(code: 'is.ui.sprintPlan.blank.description')}</p>
        ...
        <tr>
            ...
            <td>
                <is:button
                        ...
                        icon="create">
                    <strong>${message(code: 'is.ui.sprintPlan.blank.sprint.new')}</strong>
                </is:button>
            </td>
            <td class="empty">&nbsp;</td>
            <td>
                <is:button
                        ...
                        icon="create">
                    <strong>${message(code: 'is.ui.sprintPlan.blank.release.new')}</strong>
                </is:button>
            </td>
            <td class="empty">&nbsp;</td>
        </tr>
