...
<body ng-controller="appCtrl" flow-prevent-drop="" ng-class="{ 'fullscreen':app.isFullScreen, 'loading': app.loading != 100, 'spin-loading':app.stateLoading }" class="flex loading">
<div id="app-loading">
    <svg class="logo loading" width="100%" height="100%" x="0px" y="0px" viewBox="0 0 150 150" style="enable-background:new 0 0 150 150;" xml:space="preserve">
        ...
        <path fill="none" transform="" circle-coords="80,80,63,0" circle="app.loading" style="stroke: #42a9e0; stroke-width: 10px; stroke-linecap: butt;"></path>
    </svg>
</div>
