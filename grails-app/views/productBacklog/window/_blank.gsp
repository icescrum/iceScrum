...
<div class="box-blank clearfix">
  <p>${message(code:'is.ui.productBacklog.blank.description')}</p>
    ...
    <tr>
      ...
      <td>
          <is:button
            ...
            href="#sandbox/add"
            title="${message(code:'is.ui.productBacklog.blank.new')}"
            alt="${message(code:'is.ui.productBacklog.blank.new')}"
            icon="create" >
          <strong>${message(code:'is.ui.productBacklog.blank.new')}</strong>
        </is:button>
      </td>
      <td class="empty">&nbsp;</td>
    </tr>
