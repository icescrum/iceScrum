...
<div class="d-flex flex-column align-items-center">
    <h3 class="mt-3 mb-2 text-center">NEW: iceScrum Companion Mobile App</h3>
    <div class="d-flex">
        <asset:image src="/whatsNew/task-list.png" style="width: 220px; border-radius: 16px;" class="img-shadow br-2 m-3"/>
    ...
    <div>
        ...
        <a class="ml-5 mr-4" href="https://play.google.com/store/apps/details?id=com.icescrum.companion&hl=en&gl=US" target="_blank" rel="noopener noreferrer">
            <asset:image src="/whatsNew/google-play-badge.png" height="90"/>
        </a>
    </div>
</div>
