...
{
    element: "#window-id-sandbox #window-content-sandbox :first .backlog .postit-story:first, #window-content-sandbox .table-cell-postit-icon:first",
    title: "${title}",
    placement: "left",
...
{
    element: "#window-content-sandbox .postit-story:first p.postit-id, #window-id-sandbox .table-cell-postit-icon .table-cell:first",
    title: "${title}",
    placement: "left",
...
},
{
    ...
    onShown: function() {
        $("#window-content-sandbox").find(".postit-story:first .dropmenu-action .dropmenu, .dropmenu-action .dropmenu:first ").trigger('mouseenter');
    },
    onHide: function() {
        $("#window-content-sandbox").find(".postit-story:first .dropmenu-action .dropmenu, .dropmenu-action .dropmenu:first ").trigger('mouseleave');
    }
},
{
...
{
    element: "#window-content-sandbox .postit-story:first > div > div.state.task-state > div, .dropmenu-action .dropmenu:first",
    title: "${title}",
    placement: "left",
