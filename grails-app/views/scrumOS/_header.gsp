    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class="hidden-xs"
               ...
               ng-click="showAbout()">
                <svg class="logo loading" ng-class="getPushState()" width="100%" height="100%" x="0px" y="0px" viewBox="0 0 150 150" style="enable-background:new 0 0 150 150;" xml:space="preserve">
