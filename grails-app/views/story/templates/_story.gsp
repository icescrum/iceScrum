    ...
    <div as-sortable-item-handle>
        ...
        <div class="sticky-note-tags">
            <icon-badge class="float-right" tooltip="${message(code: 'is.backlogelement.tags')}"
                        ...
                        max="3"
                        hide="true"
                        count="{{:: story.tags.length }}"></icon-badge>
