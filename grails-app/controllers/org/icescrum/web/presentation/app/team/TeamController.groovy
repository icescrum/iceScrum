...
class TeamController {
    ...
    def create = {
        ...
        render template: 'dialogs/create', model: [user: (User) springSecurityService.currentUser]
    }
    ...
    def save = {
        ...
        try {
            teamService.save team, params.searchid, springSecurityService.principal?.id
    ...
    def edit = {
        ...
        render(template: "dialogs/edit", model: [team: currentTeam])
    }
