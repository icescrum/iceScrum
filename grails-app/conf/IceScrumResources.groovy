...
modules = {
    ...
    'jqplot' {
        ...
        resource url: [dir: "js/jquery", file: 'jqplot/jquery.jqplot.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.barRenderer.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.categoryAxisRenderer.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.canvasTextRenderer.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.canvasAxisTickRenderer.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.enhancedLegendRenderer.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.pointLabels.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.cursor.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jqplot/plugins/jqplot.highlighter.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
    }

    'jquery-plugins' {
        dependsOn 'jquery'
        resource url: [dir: 'js/jquery', file: 'jquery.pnotify.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jquery.history.js'], bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jquery.mousewheel.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        ...
        resource url: [dir: 'js/jquery', file: 'jquery.alphanumeric.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jquery.resize.min.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        ...
        resource url: [dir: 'js/jquery', file: 'jquery.tablesorter.min.js'], exclude:'yuijsminify', bundle: 'jquery-plugins'
        ...
        resource url: [dir: 'js/markitup/sets/textile', file: 'set.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
    ...
    'jquery-ui-plugins' {
        dependsOn 'jquery-ui'
        resource url: [dir: 'js/jquery/datepicker', file: 'jquery.ui.datepicker-en.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery/datepicker', file: 'jquery.ui.datepicker-fr.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery/datepicker', file: 'jquery.ui.datepicker-es.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery/datepicker', file: 'jquery.ui.datepicker-de.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery/datepicker', file: 'jquery.ui.datepicker-cn.js'], exclude: 'yuijsminify', bundle: 'jquery-plugins'
        resource url: [dir: 'js/jquery', file: 'jquery-ui.timepicker.js'], bundle: 'jquery-plugins'
    }
}