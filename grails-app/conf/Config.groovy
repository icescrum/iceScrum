...
icescrum.marshaller = [
        ...
        project: [include: ['owner', 'attachments', 'productOwners', 'stakeHolders', 'invitedStakeHolders', 'invitedProductOwners', 'simpleProjectApps', 'team'],
    ...
    plugin {
        springsecurity {
            ...
            filterChain.chainMap = [
                    '/ws/p/**':         'JOINED_FILTERS,-exceptionTranslationFilter,-tokenAuthenticationFilter,-restExceptionTranslationFilter', // Legacy only basic auth
