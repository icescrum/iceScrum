...
icescrum.marshaller = [
        portfolio           : [include: ['invitedBusinessOwners', 'invitedStakeHolders', 'businessOwners', 'stakeHolders'],
                               textile: ['description']],
        ...
        feature             : [include: ['countDoneStories', 'state', 'effort', 'tags', 'inProgressDate', 'doneDate'],
                               ...
                               textile: ['notes'],
                               asShort: ['color', 'name']],
        sprint              : [include: ['activable', 'reactivable', 'totalRemaining', 'duration', 'index'],
                               exclude: ['cliches'],
                               withIds: ['stories'],
                               textile: ['retrospective', 'doneDefinition'],
                               asShort: ['state', 'capacity', 'velocity', 'orderNumber', 'parentReleaseId', 'hasNextSprint', 'reactivable', 'parentReleaseName', 'parentReleaseOrderNumber', 'deliveredVersion', 'index']],
