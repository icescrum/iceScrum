...
icescrum.marshaller = [
        story: [include: ['testState', 'tags', 'dependences', 'followed', 'countDoneTasks', 'comments_count', 'attachments_count'],
                exclude: ['voters'],
                textile: ['notes'],
                asShort: ['state', 'effort', 'uid', 'name', 'rank']],
        comment: [textile: ['body'], include: ['poster']],
        project: [include: ['owner', 'productOwners', 'stakeHolders', 'invitedStakeHolders', 'invitedProductOwners', 'simpleProjectApps', 'team', 'attachments_count'],
                  exclude: ['cliches', 'teams'],
                  textile: ['description']],
        team: [include: ['members', 'scrumMasters', 'invitedScrumMasters', 'invitedMembers', 'owner']],
        task: [exclude: ['participants'],
               textile: ['notes'],
               include: ['tags', 'sprint', 'comments_count', 'attachments_count']],
        user: [exclude: ['password', 'accountExpired', 'accountLocked', 'passwordExpired', 'tokens'],
               asShort: ['firstName', 'lastName'],
               include: ['admin']],
        actor: [asShort: ['name']],
        feature: [include: ['countDoneStories', 'state', 'effort', 'tags', 'inProgressDate', 'doneDate', 'attachments_count'],
                  withIds: ['stories'],
                  textile: ['notes'],
                  asShort: ['color', 'name']],
        sprint: [include: ['activable', 'totalRemaining', 'duration', 'index', 'attachments_count'],
                 exclude: ['cliches'],
                 withIds: ['stories'],
        ...
        release: [include: ['duration', 'closable', 'activable', 'attachments_count'],
                  textile: ['vision'],
