...
icescrum.marshaller = [
        ...
        project: [include: ['owner', 'attachments', 'productOwners', 'stakeHolders', 'invitedStakeHolders', 'invitedProductOwners', 'simpleProjectApps'],
                  exclude: ['cliches'],
                  textile: ['description']],
    ...
    plugin {
        springsecurity {
            ...
            filterChain.chainMap = [
                    '/ws/p/**':         'JOINED_FILTERS,-exceptionTranslationFilter,-anonymousAuthenticationFilter,-tokenAuthenticationFilter,-restExceptionTranslationFilter', // Legacy only basic auth
