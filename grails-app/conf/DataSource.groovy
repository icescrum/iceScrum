...
////      -- MySQL
        dataSource {
            ...
            url = "jdbc:mysql://localhost:3306/total_backlog?useUnicode=true&characterEncoding=utf8" // docker run --name mysql -e MYSQL_ROOT_PASSWORD=root -e MYSQL_DATABASE=icescrum -p 3306:3306 -d mysql:latest --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci
        }
////      -- PostgreSQL
//        dataSource {
//            dbCreate = "update"
