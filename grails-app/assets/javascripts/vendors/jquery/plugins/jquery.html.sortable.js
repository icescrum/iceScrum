...
(function ($) {
    ...
    $.fn.sortable = function (options) {
        ...
        return this.each(function () {
            var sortable = $(this);
            if (method === 'reload') {
                sortable.children(options.items).off('dragstart.h5s dragend.h5s selectstart.h5s dragover.h5s dragenter.h5s drop.h5s');
            }
            ...
            var isHandle, index, items = sortable.children(options.items);
            ...
            items.attr('draggable', 'true').on('dragstart.h5s',function (e) {
                ...
                dragging = $(this);
                index = dragging.parent().children(options.items).index(dragging);
                ...
                timeout = setTimeout( function(){
                    ...
                    clearTimeout( timeout );
                    timeout = setTimeout( function(){
                        if( !showDrag ){ sortable.removeClass('dragging'); }
                    }, 200 );
                }, 200 );
